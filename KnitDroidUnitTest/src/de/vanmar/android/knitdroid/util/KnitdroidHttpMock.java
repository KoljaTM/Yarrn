...
public class KnitdroidHttpMock extends NanoHTTPD {

    public KnitdroidHttpMock(final int port, final File wwwroot)
            throws IOException {
        super(port, wwwroot);
    }
    ...
    public static void main(final String[] args) {
        ...
        try {
            ...
            new KnitdroidHttpMock(port, wwwroot);
